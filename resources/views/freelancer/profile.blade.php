                    ...
                    <div class="card-body">
                        <div class="thumb-info mb-3">
                            <div class="col-md-2 text-center">
                                @if(!empty($profile->photo))
                                    <img class="p-0 profilepicture rounded-circle"
                                         src="/storage/photo/{{$profile->photo}}" data-toggle="modal"
                                         data-target="#uploadphoto{{$user->id}}">
                                @else
                                ...
                                <div class="modal fade" id="uploadphoto{{$user->id}}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <form action="/profile/uploadphoto" method="POST"
                                                  enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                <div class="modal-header">
                                                    <h5 class="modal-title text-info" id="exampleModalLabel">Upload
                                                        Photo</h5>
                            ...
                            <div class="thumb-info-title">
                                <span class="thumb-info-inner"><h6>{{$user->name}}</h6></span>

                                <span class="thumb-info-type">  <h6 class="h7">
                       @if ($profile !== null)
                                            {{$profile->job_title}}
                                        @endif
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <h4 class="h5 text-info">About</h4>
                                <p>{!! truncateString($profile !== null ? nl2br(e($profile->overview)) : '',50) !!}</p>
                            </div>
                        </div>
                        <div class="clearfix">
                ...
                <div class="card mb-0">
                    ...
                    <div class="card-body" id="educationBackgroundBody">
                        @foreach($educations as $education)
                            <div>
                                <p class="float-right text-danger targetEducDiv"><i class="far fa-trash-alt"
                                                                                    data-toggle="modal"
                                                                                    data-target="#deleteEducation{{$education->id}}"></i>
                                </p>
                                <p class="float-right text-info mr-4"><i class="fas fa-pencil-alt"
                                                                         data-id="{{$education->id}}"
                                                                         data-toggle="modal"
                                                                         data-target="#editeducation{{$education->id}}"></i>
                                </p>
                    ...
                    <!-- Edit Skills Modal -->
                    <div class="modal fade" id="editskills{{$user->id}}" tabindex="-1" role="dialog"
                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body editskillsbody">
                                        <select class="form-control selectedskills" multiple="multiple"
                                                placeholder="Select State" name="skills[]">
                                            <option></option>
                    ...
                    <!-- Add Skills Modal -->
                    <div class="modal fade" id="addskills{{$user->id}}" tabindex="-1" role="dialog"
                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div>
                                    <p class="float-right text-danger targetWorkDiv">
                                        <i class="far fa-trash-alt" data-toggle="modal"
                                           data-target="#deleteWork{{$work->id}}"></i>
                                    </p>
